<template>
  <div>
    ...
    <b-table striped hover :sticky-header="true" :items="examConfigs" class="mb-2 mt-2">
    ...
    >
      <form ref="form" @submit.stop.prevent="handleNameSubmit">
        ...
        <b-form-group :state="nameState" label="Name Changer" label-for="name-input">
          <b-form-input id="name-input" v-model="name" :state="nameState" required></b-form-input>
          <b-form-invalid-feedback
            :state="nameState"
          >The name length must be between 5 and 200 characters.</b-form-invalid-feedback>
          <b-form-valid-feedback :state="nameState">Looks Good.</b-form-valid-feedback>
        </b-form-group>
      </form>
    </b-modal>
    <!-- Time Changer Modal-->
    ...
    >
      <form ref="form" @submit.stop.prevent="handleTimeSubmit">
        ...
        <b-form-group :state="timeState" label="Hours" label-for="name-input">
          <b-form-input
            id="hours-input"
            :type="'number'"
            v-model="hours"
        ...
        <b-form-group :state="timeState" label="Minutes" label-for="name-input">
          <b-form-input
            id="minutes-input"
            :type="'number'"
            v-model="minutes"
            ...
            required
          ></b-form-input>
          <b-form-invalid-feedback :state="timeState">Put correct time</b-form-invalid-feedback>
        </b-form-group>
      </form>
    </b-modal>
    <!-- Count Changer Modal-->
    ...
    >
      <form ref="form" @submit.stop.prevent="handleCountSubmit">
        <h4>{{dialogDesciption}} = {{currentCount}}</h4>
        <b-form-group :state="countState" label="Computers Count" label-for="name-input">
          <b-form-input
            id="hours-input"
            :type="'number'"
            v-model="count"
            ...
            required
          ></b-form-input>
          <b-form-invalid-feedback :state="countState">Put correct count</b-form-invalid-feedback>
          <b-form-valid-feedback :state="countState">Looks Good.</b-form-valid-feedback>
        </b-form-group>
      </form>
    </b-modal>
  </div>
...
export default {
  ...
  computed: {
    ...
    countState: function() {
      if (parseInt(this.count) == 0) return null;
      else return parseInt(this.count) != parseInt(this.currentCount);
    },
    timeState: function() {
    ...
    showDialog(config) {
      switch (config.id) {
        ...
        case 12:
          ...
          this.dialogTitle = `Change Questions Count (${config.name})`;
          this.showCountDialg(config);
          break;
        case 2:
        case 3:
