<template>
  <div>
    ...
    <div class="form-group row mb-0 justify-content-center">
      <button @click="chooseDates()" class="btn btn-primary mr-2">Print</button>
    ...
    <b-modal ref="my-modal" hide-footer title="Reservation Dates">
      ...
      <b-container fluid>
        <b-row class="my-1">
          ...
          <b-col sm="9">
            <b-form-input id="input-start" v-model="startDate" type="date" :state="startState"></b-form-input>
            <b-form-invalid-feedback id="input-start-feedback">Choose Correct Start Date</b-form-invalid-feedback>
          </b-col>
        </b-row>
        <b-row class="my-1">
          <b-col sm="3">
          ...
          <b-col sm="9">
            <b-form-input id="input-end" v-model="endDate" type="date" :state="endState"></b-form-input>
            <b-form-invalid-feedback id="input-end-feedback">Choose Correct End Date</b-form-invalid-feedback>
          </b-col>
        </b-row>
        <b-row class="my-1">
...
export default {
  ...
  methods: {
    ...
    getStudents() {
      this.clearMessage();
      axios
        .get(`/students/${this.group}/certificates`)
        .then(response => {
    ...
    chooseDates() {
      if (this.students.length > 0) this.showModal();
      else {
    ...
    print() {
      ...
      axios
        .post("/students/" + this.group + "/print", {
