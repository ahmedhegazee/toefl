<div class="form-group row">
    ...
    <div class="col-md-6">
        <input id="title" type="text" pattern="[A-Za-z0-9 ]+" class="form-control @error('title') is-invalid @enderror"
               name="title"
    ...
    <div class="col-md-6">
        <select id="type" name="type" class="form-control">
            ...
            @foreach($types as $type)
                <option
                    value="{{$type->id}}" {{isset($audio)&&$audio->type->id==$type->id?'selected':''}}>{{$type->type}}</option>
            @endforeach
