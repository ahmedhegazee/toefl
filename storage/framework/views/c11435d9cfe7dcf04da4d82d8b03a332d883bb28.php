        ...
        <table border="2px solid">
            ...
            <?php $__currentLoopData = $questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $question): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    <td>
                        <a href="<?php echo e(route('paragraph.question.edit',['question'=>$question,'paragraph'=>$paragraph])); ?>" class="btn btn-success">Edit</a>
                        <form style="display: inline;" method="post" action="<?php echo e(route('paragraph.question.destroy',['question'=>$question,'paragraph'=>$paragraph])); ?>">
